...
public class PatientController {
	...
	public Patient getPatientMedHistByID(@PathVariable Long id) {
	...
	public Patient getPatientMedHistByName(@PathVariable String name) {
	...
	public List<Patient> getAllPatientsWithDisease(@PathVariable String disease) {
